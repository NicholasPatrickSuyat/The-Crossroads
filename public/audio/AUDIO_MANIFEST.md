...
at the paths below — **do not use copyrighted film or franchise scores**.
...
| Hearth Hollow ambience | `public/audio/ambience/shire.ogg` | Ogg, seamless loop | Soft breeze / nature. (path key retained) |
| Mistveil ambience | `public/audio/ambience/mountains.ogg` | Ogg, seamless loop | Low wind / airy. |
| Ashen Reach ambience | `public/audio/ambience/mordor.ogg` | Ogg, seamless loop | Distant rumble / embers. (path key retained) |
